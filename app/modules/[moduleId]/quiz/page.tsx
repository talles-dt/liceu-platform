      ...
      {QUESTIONS.length === 0 ? (
        ...
        <div className="space-y-8">
          <section className="space-y-3">
            ...
            <p className="font-[var(--font-noto-serif)] text-[18px] leading-[1.7] text-[var(--liceu-text)]">
              {q.prompt}
            </p>
          </section>
            ...
            {q.options.map((opt) => (
              <label
                ...
                className={[
                  ...
                  "hover:border-[var(--liceu-secondary)]/35",
                  submitted && selected === opt.id
                    ? "border-[var(--liceu-secondary)]/55"
                    : "",
                ].join(" ")}
              >
                <input
                  ...
                  className="mt-1 h-3 w-3 accent-[var(--liceu-secondary)]"
                />
